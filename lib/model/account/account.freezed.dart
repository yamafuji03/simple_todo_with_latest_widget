...
class _$AccountImpl implements _Account {
  const _$AccountImpl(
      {this.email, this.uid, @TimestampConverter() this.registerDate});
  ...
  @override
  String toString() {
    return 'Account(email: $email, uid: $uid, registerDate: $registerDate)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, email, uid, registerDate);
...
abstract class _Account implements Account {
  const factory _Account(
      {final String? email,
      final String? uid,
      @TimestampConverter() final DateTime? registerDate}) = _$AccountImpl;
